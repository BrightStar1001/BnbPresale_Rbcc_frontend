...
type Props = {
    isUpdatePresaleOpen: boolean;
    setIsUpdatePresaleOpen: (status: boolean) => void;
    updatePresaleFn: (maxTokens:string, tokenPriceStr:string, minPerWallet:string, maxPerWallet:string, whitelistEnabled:boolean) => void;
}

export default function UpdatePresaleModal({isUpdatePresaleOpen, setIsUpdatePresaleOpen, updatePresaleFn}: Props) {
    function closeModal() {
        setIsUpdatePresaleOpen(false)
    }

    function updatePresaleClicked() {
        updatePresaleFn(maxTokens, tokenPriceStr, minPerWallet, maxPerWallet, whitelistEnabled);
        setIsUpdatePresaleOpen(false)
    }
    ...
    return (
      <>
        <Transition appear show={isUpdatePresaleOpen} as={Fragment}>
            ...
            <div className="fixed inset-0 overflow-y-auto font-['inter']">
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-[#000520]/[.95] border-[gray] border p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    <div className="font-['inter'] detail-text small border-[#fff]/[.15] border-b text-[#a3a7bf]">UPDATE PRESALE</div>
                  </Dialog.Title>
                  <div className="mt-2">
